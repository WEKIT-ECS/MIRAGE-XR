 ...
 *   
 *   2017-03-02 Update (Roland Klemke):
 *   - added saving/loading as JSON file
 * 
 * * * * */
using System;
...
namespace SimpleJSON
{
	...
	public abstract partial class JSONNode
	{
		...
		/// </summary>
		/// <param name="filename"></param>
		public static JSONNode LoadFromJsonFile(string filename)
		{
