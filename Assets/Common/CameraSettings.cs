...
public class CameraSettings : MonoBehaviour
{
   ...
   // private CameraDirection mActiveDirection = CameraDirection.CAMERA_DEFAULT;
    ...
    /*
    public void SelectCamera(CameraDirection camDir)
    {
    ...
    */
    ...
    {
        return (mActiveDirection == CameraDirection.CAMERA_FRONT);
    }
    */
