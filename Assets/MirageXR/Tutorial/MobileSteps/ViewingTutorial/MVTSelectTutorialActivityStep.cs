...
namespace MirageXR
{
    ...
    public class MVTSelectTutorialActivityStep : TutorialStep
    {
        protected override void SecuredEnterStep()
        {
            ...
            queue.Enqueue(new TutorialModel { id = "tutorial_activity", message = "Welcome to the eRobson Viewing Tutorial! To start, click on the specially prepared Tutorial Activity highlighted on your screen.", position = TutorialModel.MessagePosition.Bottom });
