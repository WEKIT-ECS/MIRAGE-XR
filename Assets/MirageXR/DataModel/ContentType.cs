...
public static class ContentTypeExtenstion
{
    ...
    private const string VIRTUALINSTRUCTOR = "Virtual instructor";
    ...
    private const string PREDICATE_VIRTUALINSTRUCTOR = "virtualinstructor";
    ...
    private const string VIRTUALINSTRUCTOR_HINT = "Hint"; // TODO% add hint
    ...
    private const string VIRTUALINSTRUCTOR_IMAGE_PATH = "Icons/Editors/character"; // TODO: add new icon
    ...
    public static string GetName(this ContentType type)
    {
        switch (type)
        {
            ...
            case ContentType.VIRTUALINSTRUCTOR: return VIRTUALINSTRUCTOR;
            default:
    ...
    private static string GetImagePath(this ContentType type)
    {
        switch (type)
        {
            ...
            case ContentType.VIRTUALINSTRUCTOR: return VIRTUALINSTRUCTOR_IMAGE_PATH;
            default:
                throw new ArgumentOutOfRangeException(nameof(type), type, null);
        }
    }
    ...
    public static string GetHint(this ContentType type)
    {
        switch (type)
        {
            ...
            case ContentType.VIRTUALINSTRUCTOR: return VIRTUALINSTRUCTOR_HINT;
            default:
                throw new ArgumentOutOfRangeException(nameof(type), type, null);
        }
    }
    ...
    public static string GetPredicate(this ContentType type)
    {
        switch (type)
        {
            ...
            case ContentType.VIRTUALINSTRUCTOR: return PREDICATE_VIRTUALINSTRUCTOR;
            default:
                throw new ArgumentOutOfRangeException(nameof(type), type, null);
        }
    }
    ...
    public static ContentType ParsePredicate(string predicate)
    {
        ...
        if (predicateLowCase.StartsWith(PREDICATE_VIRTUALINSTRUCTOR))
            return ContentType.VIRTUALINSTRUCTOR;
