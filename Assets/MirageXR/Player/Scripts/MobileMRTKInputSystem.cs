...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class MobileMRTKInputSystem : BaseDataProviderAccessCoreSystem, IMixedRealityInputSystem, IMixedRealityCapabilityCheck
    {
        [Obsolete("This constructor is obsolete (registrar parameter is no longer required) and will be removed in a future version of the Microsoft Mixed Reality Toolkit.")]
        public MobileMRTKInputSystem(IMixedRealityServiceRegistrar registrar, MixedRealityInputSystemProfile profile) : this(profile)
        {
            Registrar = registrar;
        }

        public MobileMRTKInputSystem(MixedRealityInputSystemProfile profile) : base(profile) { }
