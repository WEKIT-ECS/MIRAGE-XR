...
namespace MirageXR
{
    public class ActivateKeyboard : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Keyboard for this display to monitor and interact with. If empty this will default to the KeyboardManager keyboard.")]
        XRKeyboard m_Keyboard;

        /// <summary>
        /// Keyboard for this display to monitor and interact with. If empty this will default to the <see cref="KeyboardManager"/> keyboard.
        /// </summary>
        ...
        void Start()
        {
            ...
            if (m_ActiveKeyboard == null || !m_UseSceneKeyboard)
                m_ActiveKeyboard = KeyboardManager.instance.keyboard;
        ...
        void OnInputFieldGainedFocus(string text)
        {
            ...
            if (m_IsActivelyObservingKeyboard && !alwaysObserveKeyboard)
            {
                if (!m_UseSceneKeyboard || m_Keyboard == null)
                    KeyboardManager.instance.RepositionKeyboardIfOutOfView();
            ...
            if (!m_UseSceneKeyboard || m_Keyboard == null)
            {
                KeyboardManager.instance.ShowKeyboard(m_InputField, m_MonitorInputFieldCharacterLimit);
            }
            else
            {
