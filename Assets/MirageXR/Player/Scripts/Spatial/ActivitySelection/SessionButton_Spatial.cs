...
namespace MirageXR
{
    [RequireComponent(typeof(SessionContainerListItem_Spatial))]
    public class SessionButton_Spatial : MonoBehaviour
    {
        ...
        [SerializeField] private SessionContainerListItem_Spatial _selectedListViewItem;
