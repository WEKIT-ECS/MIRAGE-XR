...
namespace MirageXR
{
    ...
    public class ImageMarkerPopup : PopupBase
    {
        ...
        public void SetImage(String url)
        {
            ...
            byte[] byteArray = File.ReadAllBytes(Path.Combine(RootObject.Instance.activityManager.ActivityPath, url));
            ...
            else
            {
                ...
                _txtInstruction.text = "Image not found at: \n" + RootObject.Instance.activityManager.ActivityPath + url;
            }
        }
