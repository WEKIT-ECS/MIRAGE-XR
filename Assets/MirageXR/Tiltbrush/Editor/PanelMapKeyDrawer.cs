...
public class PanelMapKeyDrawer : PropertyDrawer {
  ...
  public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label) {
    ...
    if (panelType != BasePanel.PanelType.SketchSurface) {
      ...
      NextRect(baseX, pos.y, 30, baseHeight, 30);
      EditorGUI.LabelField(drawRect, new GUIContent("Adv"));

      NextRect(baseX, pos.y, 10, baseHeight, 12);
      EditorGUI.PropertyField(drawRect, prop.FindPropertyRelative("m_TrackedHands"), GUIContent.none);
      NextRect(baseX, pos.y, 30, baseHeight, 30);
      EditorGUI.LabelField(drawRect, new GUIContent("Hands"));
    }
