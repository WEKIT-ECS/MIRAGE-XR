...
namespace TiltBrush
{
  ...
  public class SketchControlsScript : MonoBehaviour
  {
    ...
    [SerializeField] public float m_DefaultSketchLoadSpeed;
    ...
    //Set to true when using MRTK as it provides its own reticle
    [SerializeField] bool reticleDisabled = false;
    ...
    public Action<bool> PanelsVisibilityChangeRequested;
    ...
    public bool IsViewOnly() { return m_ViewOnly; }
    ...
    void Start()
    {
      ...
      m_UIReticleMobile.SetActive(m_ControlsType == ControlsType.ViewingOnly && !reticleDisabled);
      m_UIReticleSixDofController.SetActive(m_ControlsType != ControlsType.ViewingOnly && !reticleDisabled);
    ...
    public void UpdateControls()
    {
      ...
      if (!PointerManager.m_Instance.IsMainPointerProcessingLine() && !m_ViewOnly)
      {
    ...
    void UpdateCurrentGazeRay()
    {
      ...
      if (hasController)
      {
        if (InputManager.Brush.IsTrackedObjectValid)
        {
          ...
          m_GazeControllerRay = FocusDataProvider.Instance.GetMainPointerRay();
        }
        else
        {
    ...
    //     {
    //       SetToolSize(m_AdjustToolSizeScalar * InputManager.m_Instance.GetAdjustedBrushScrollAmount());
    //     }
    ...
    void SetToolSize(float size)
    {
      ...
      m_SketchSurfacePanel.UpdateToolSize(size);
    }
    ...
    public void RequestPanelsVisibility(bool bVisible)
    {
      ...
      PanelsVisibilityChangeRequested?.Invoke(bVisible);
    }
    ...
    public bool IsCommandActive(GlobalCommands rEnum, int iParam = -1)
    {
      switch (rEnum)
      {
        case GlobalCommands.ViewOnly: return m_ViewOnly;
