...
namespace MirageXR
{
    ...
    public class VirtualInstructor : MirageXRPrefab
    {
        ...
        public async Task<AudioClip> AskVirtualInstructorAudio(AudioClip inputAudio)
        {
        ...
        /// </summary>
        /// <param name="optionalmessage">Optional message to be sent along with the message queue.</param>
        /// <returns>The speech audio clip generated by the virtual instructor in response to the message.</returns>
        public async Task<AudioClip> AskInstructorWithStringQuestion(string optionalmessage = "")
        {
            ...
            try
            {
                ...
                {
                    final = optionalmessage + " " + MessageQueue;
                }
                else
                {
                    final = MessageQueue;
                ...
                UpdateHistory(optionalmessage, response);
                return clip;
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        private string CreateContext() => !string.IsNullOrEmpty(_history) ? InstructorData.Prompt + _history + MessageQueue : InstructorData.Prompt;
