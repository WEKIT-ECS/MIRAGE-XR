...
{
    /// <summary>
    /// Description of the user information data for the Sketchfab client
    /// </summary>
    public class SketchfabUserInfo : IUserInfo
    {
        ...
        /// <summary>
        /// Creates a new instance of the sketchfab user info with the given parameters
        /// </summary>
        /// <param name="username">The user name of the user</param>
        /// <param name="email">The email address of the user</param>
        /// <param name="fullName">The full name of the user</param>
        public SketchfabUserInfo(string username, string email, string fullName)
        {
