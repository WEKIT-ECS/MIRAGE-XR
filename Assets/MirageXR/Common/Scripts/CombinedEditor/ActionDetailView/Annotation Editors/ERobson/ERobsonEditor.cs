...
namespace MirageXR
{
    public class ERobsonEditor : MonoBehaviour
    {
        ...
        private void Create(string iconName)
        {
            ...
            _annotationToEdit.predicate = "eRobson:" + iconName;
            name = _annotationToEdit.predicate;
